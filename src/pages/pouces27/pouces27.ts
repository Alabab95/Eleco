...
/**
 * Generated class for the Pouces27Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-pouces27',
  templateUrl: 'pouces27.html',
})
export class Pouces27Page {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController,afdb : AngularFireDatabase ,public navParams: NavParams) {
    this.items = afdb.list('Products/pouces27/').valueChanges();
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Pouces27Page');
  }
