...
@Component({
  selector: 'page-largeur60cm-pose-libre',
  templateUrl: 'largeur60cm-pose-libre.html'
})
export class Largeur60CmPoseLibrePage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController,afdb : AngularFireDatabase ) {
    this.items = afdb.list('Products/Largeur60Libre/').valueChanges();
