...
export class Taille70100CmPage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer  , public navCtrl: NavController, public navParams: NavParams, afDB: AngularFireDatabase) {
