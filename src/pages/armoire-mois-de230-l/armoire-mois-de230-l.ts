...
@Component({
  selector: 'page-armoire-mois-de230-l',
  templateUrl: 'armoire-mois-de230-l.html',
})
export class ArmoireMoisDe230LPage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController, private afdb : AngularFireDatabase ) {
    this.items = afdb.list('Products/am230/').valueChanges();
