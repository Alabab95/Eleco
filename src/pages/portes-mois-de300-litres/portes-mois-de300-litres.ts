...
@Component({
  selector: 'page-portes-mois-de300-litres',
  templateUrl: 'portes-mois-de300-litres.html',
})

export class PortesMoisDe300LitresPage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController, private afdb : AngularFireDatabase ) {
    this.items = afdb.list('Products/2pm300/').valueChanges();
