...
@Component({
  selector: 'page-1-porte-avec-congelateur',
  templateUrl: '1-porte-avec-congelateur.html',
})
export class PorteAvecCongelateurPage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController, private afdb : AngularFireDatabase ) {
    this.items = afdb.list('Products/1pac/').valueChanges();
