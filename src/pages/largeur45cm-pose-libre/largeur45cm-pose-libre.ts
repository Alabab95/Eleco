...
@Component({
  selector: 'page-largeur45cm-pose-libre',
  templateUrl: 'largeur45cm-pose-libre.html'
})
export class Largeur45CmPoseLibrePage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController,afdb : AngularFireDatabase ) {
    this.items = afdb.list('Products/Largeur45Libre/').valueChanges();
