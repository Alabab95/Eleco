...
@Component({
  selector: 'page-armoire-plus-de230-l',
  templateUrl: 'armoire-plus-de230-l.html',
})

export class ArmoirePlusDe230LPage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController, private afdb : AngularFireDatabase ) {
    this.items = afdb.list('Products/ap230/').valueChanges();
