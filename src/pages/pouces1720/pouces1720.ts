...
/**
 * Generated class for the Pouces1720Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-pouces1720',
  templateUrl: 'pouces1720.html',
})
export class Pouces1720Page {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController,afdb : AngularFireDatabase ,public navParams: NavParams) {
    this.items = afdb.list('Products/pouces1720/').valueChanges();
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Pouces1720Page');
  }
