...
/**
 * Generated class for the CompatiblesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-compatibles',
  templateUrl: 'compatibles.html',
})
export class CompatiblesPage {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController,afdb : AngularFireDatabase ) {
    this.items = afdb.list('Products/compatibles/').valueChanges();
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CompatiblesPage');
  }
