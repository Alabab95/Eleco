...
@Component({
  selector: 'page-go-to-impr-couleur1-20',
  templateUrl: 'go-to-impr-couleur1-20.html',
})
export class GoToImprCouleur1_20Page {
  ...
  constructor(public toastCtrl: ToastController ,public sanitizer : DomSanitizer   , public navCtrl: NavController,afdb : AngularFireDatabase ,public navParams: NavParams) {
    this.items = afdb.list('Products/Imp120/').valueChanges();
